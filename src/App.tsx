...
import AbdmSuite from './components/AbdmSuite';
...
const navItems = [
  ...
  { name: 'Patient Registration', icon: UserPlus, path: '/registration', roles: ['SUPER_ADMIN', 'DOCTOR', 'RECEPTIONIST', 'RECEPTION', 'FRONT_DESK', 'NURSE', 'ACCOUNTANT'] },
