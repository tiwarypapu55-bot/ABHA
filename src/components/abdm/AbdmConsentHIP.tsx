            ...
            <div className="p-5 space-y-4 animate-fade-in text-xs">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <Select value={newDocFacility || 'Global Hospital Clinic'} onValueChange={setNewDocFacility}>
                    <SelectTrigger className="h-8.5 text-xs bg-slate-50/50">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent className="text-xs">
                      <SelectItem value="Global Hospital Clinic">GLOBAL HOSPITAL & MATERNITY center</SelectItem>
